...
//	public int mProgram, mPositionHandle, mColorHandle;
//
...
//
//		int vertexShader = FrameRenderer.loadShader(GLES20.GL_VERTEX_SHADER,
//				vertexShaderCode);
//		int fragmentShader = FrameRenderer.loadShader(
