...
public class Vect3 {
	 ...
	 */
	public void norm() {
		double abs = Math.sqrt(vect[0] * vect[0] + vect[1] * vect[1] + vect[2]
				* vect[2]);
		vect[0] = (float) (vect[0] / abs);
		vect[1] = (float) (vect[1] / abs);
		vect[2] = (float) (vect[2] / abs);

	}
	
	public float getYRot() {
		float a = -vect[0]/vect[2];
		a = (float)Math.toDegrees(Math.atan(a));
		return a;
	}
