...
public class TestLevel extends Level {
	...
	public Player load() {
		...
		try {
			...
			world.createStatic(new Triangle(3, 3, black, 2, 0, 2, true));
			world.createStatic(new Rectangle(2, 2, black, -2.5f, -1, 2, true));
			world.createStatic(new Rectangle(2, 2, black, 3, 2, 2, true));
			world.createStatic(new SymmetricPolygon(8, 2, red, 2, -2, 2, true));
			world.createStatic(new Rectangle(2, 2, green, -1, -1, 3, false));
			...
			world.createStatic(new Rectangle(15, 2, black, -15, -5, 2, true));
